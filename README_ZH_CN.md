...
在对任何请求进行签名之前，您必须通过 BitMore 网站【用户中心】-【API】创建一个API key。 创建key后，您将获得3个必须记住的信息：
* API Key
...
REST访问的根URL：`https://www.bitmore.top`
